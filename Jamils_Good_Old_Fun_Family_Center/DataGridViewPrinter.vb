'code accessed from https://www.planet-source-code.com/vb/scripts/ShowCode.asp?txtCodeId=7777&lngWId=10
'Date: 2017-2-25
'function: prints a data grid view through a module call, using an enhanced print priview dialog box

'changes: try catch to draw null cell values, remove the minus 1 from row count, it cause the grid to not draw last row
            ...
            Else
                ...
                For Each oCell As DataGridViewCell In oRow.Cells
                    If oCell.Visible = True Then
                        ...
                        'trys to get a value, if null draws a blank text cell
                        Try
